...
import { api, type EnvVarMasked, type Service } from "@/lib/api";
...
export function ServicePanel({
  ...
  return (
    <Sheet open={!!service} onOpenChange={onOpenChange}>
      {service && <ServicePanelContent key={service.id} service={service} onDeleted={onDeleted} />}
    </Sheet>
  );
}

function ServicePanelContent({ service, onDeleted }: { service: Service; onDeleted: () => void }) {
